...
function meditation_and_yoga_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('meditation_and_yoga_logo_size',array(
		'sanitize_callback'	=> 'meditation_and_yoga_sanitize_float'
	));
	$wp_customize->add_control('meditation_and_yoga_logo_size',array(
		'type' => 'range',
		'label' => __('Logo Size','meditation-and-yoga'),
   ...
   $wp_customize->add_control('meditation_and_yoga_show_site_title',array(
	...
	$wp_customize->add_setting( 'meditation_and_yoga_site_title_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_site_title_color', array(
		'label' => 'Title Color',
		'section' => 'title_tagline',
	)));
   ...
   $wp_customize->add_control('meditation_and_yoga_show_tagline',array(
	...
	$wp_customize->add_setting( 'meditation_and_yoga_site_tagline_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_site_tagline_color', array(
		'label' => 'Tagline Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'meditation_and_yoga_boxfull_width', array(
		'default'           => '',
		'sanitize_callback' => 'meditation_and_yoga_sanitize_choices'
	));
	
	$wp_customize->add_control( 'meditation_and_yoga_boxfull_width', array(
		'label'    => __( 'Section Width', 'meditation-and-yoga' ),
		'section'  => 'meditation_and_yoga_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'container'  => __('Box Width', 'meditation-and-yoga'),
			'container-fluid' => __('Full Width', 'meditation-and-yoga'),
			'none' => __('None', 'meditation-and-yoga')
		),
	));

	$wp_customize->add_setting( 'meditation_and_yoga_dropdown_anim', array(
		'default'           => 'None',
		'sanitize_callback' => 'meditation_and_yoga_sanitize_choices'
	));
	$wp_customize->add_control( 'meditation_and_yoga_dropdown_anim', array(
		'label'    => __( 'Menu Dropdown Animations', 'meditation-and-yoga' ),
		'section'  => 'meditation_and_yoga_theme_options_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInUp'  => __('bounceInUp', 'meditation-and-yoga'),
			'fadeInUp' => __('fadeInUp', 'meditation-and-yoga'),
			'zoomIn'    => __('zoomIn', 'meditation-and-yoga'),
			'None'    => __('None', 'meditation-and-yoga')
		),
	));
	...
	$wp_customize->add_setting( 'meditation_and_yoga_toptext_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_toptext_color', array(
		'label' => 'Text Color',
		'section' => 'meditation_and_yoga_contact_details',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_topicon_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_topicon_color', array(
		'label' => 'Icon Color',
		'section' => 'meditation_and_yoga_contact_details',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_topbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_topbg_color', array(
		'label' => 'Background Color',
		'section' => 'meditation_and_yoga_contact_details',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_searchtext_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_searchtext_color', array(
	...
	$wp_customize->add_setting( 'meditation_and_yoga_slider_effect', array(
		'default'           => '',
		'sanitize_callback' => 'meditation_and_yoga_sanitize_choices'
	));
	$wp_customize->add_control( 'meditation_and_yoga_slider_effect', array(
		'label'    => __( 'Onload Transactions Effects', 'meditation-and-yoga' ),
		'section'  => 'meditation_and_yoga_slider_section',
		'type'     => 'select',
		'choices'  => array(
			'bounceInLeft'  => __('bounceInLeft', 'meditation-and-yoga'),
			'bounceInRight' => __('bounceInRight', 'meditation-and-yoga'),
			'bounceInUp'    => __('bounceInUp', 'meditation-and-yoga'),
			'bounceInDown'    => __('bounceInDown', 'meditation-and-yoga'),
			'zoomIn'  => __('zoomIn', 'meditation-and-yoga'),
			'zoomOut' => __('zoomOut', 'meditation-and-yoga'),
			'fadeInDown'    => __('fadeInDown', 'meditation-and-yoga'),
			'fadeInUp'    => __('fadeInUp', 'meditation-and-yoga'),
			'fadeInLeft'  => __('fadeInLeft', 'meditation-and-yoga'),
			'fadeInRight' => __('fadeInRight', 'meditation-and-yoga'),
			'flip-up'    => __('flip-up', 'meditation-and-yoga'),
			'none'    => __('none', 'meditation-and-yoga')
		),
	));
	...
	$wp_customize->add_setting( 'meditation_and_yoga_slider_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_slider_color', array(
		'label' => 'Text Color',
		'section' => 'meditation_and_yoga_slider_section',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_sliderbtn_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_sliderbtn_color', array(
		'label' => 'Button Text Color',
		'section' => 'meditation_and_yoga_slider_section',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_sliderbtnbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_sliderbtnbg_color', array(
		'label' => 'Button Bg Color',
		'section' => 'meditation_and_yoga_slider_section',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_slidernp_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_slidernp_color', array(
		'label' => 'Arrow Color',
		'section' => 'meditation_and_yoga_slider_section',
	)));

	$wp_customize->add_setting( 'meditation_and_yoga_slidernpbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_slidernpbg_color', array(
	...
	$wp_customize->add_setting('meditation_and_yoga_img_hight',array(
		'default' => '',
		'sanitize_callback'	=> 'meditation_and_yoga_sanitize_float'
	));
	$wp_customize->add_control('meditation_and_yoga_img_hight',array(
		'type' => 'number',
		'label' => __('Image Hight','meditation-and-yoga'),
		'section' => 'meditation_and_yoga_service',
	));
	...
	$wp_customize->add_setting( 'meditation_and_yoga_service_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'meditation_and_yoga_service_color', array(
		'label' => 'Text Color',
		'section' => 'meditation_and_yoga_service',
	)));
   ...
   $wp_customize->add_section( 'meditation_and_yoga_footer', array(
    	'title'      => __( 'Footer Setting', 'meditation-and-yoga' ),
		'priority'   => null,
		'panel' => 'meditation_and_yoga_panel_id'
	) );
   ...
   $wp_customize->add_setting('meditation_and_yoga_footer_link',array(
	...
	$wp_customize->add_control('meditation_and_yoga_footer_link',array(
		'label'	=> __('Copyright Link','meditation-and-yoga'),
		'section'	=> 'meditation_and_yoga_footer',
	...
	$wp_customize->add_control('meditation_and_yoga_footer_copy',array(
		'label'	=> __('Copyright Text','meditation-and-yoga'),
		'section'	=> 'meditation_and_yoga_footer',
