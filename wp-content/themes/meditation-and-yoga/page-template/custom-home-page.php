...
<?php if( get_theme_mod('meditation_and_yoga_slider_hide_show',false) != false){ ?>
	<?php
	$container_type = get_theme_mod('meditation_and_yoga_boxfull_width', ''); // Get the selected container type
	  	...
	  	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
		    ...
		    <div class="carousel-inner" role="listbox">
		        ...
		        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		          	...
		          	<?php
						$meditation_and_yoga_slider_effect = get_theme_mod('meditation_and_yoga_slider_effect', '') 
					 ?>
					<div class="carousel-caption <?php echo ($meditation_and_yoga_slider_effect); ?>">
			            <div class="inner_carousel">
			              	<h1><?php the_title(); ?></h1>
			           		<p><?php $meditation_and_yoga_excerpt = get_the_excerpt(); echo esc_html( meditation_and_yoga_string_limit_words( $meditation_and_yoga_excerpt, esc_attr(get_theme_mod('meditation_and_yoga_slider_excerpt_length','15') ) )); ?></p>
			              	<div class="read-btn">
